...
<div class="relative featured-cat-cover">
  ...
  <a href=<?php the_permalink();?> class="featured-cat-content ph5 pv4 absolute  z-3 w-50-ns center center bottom-0 no-deco" style="background-color: <?php echo $bgColor;?>">
